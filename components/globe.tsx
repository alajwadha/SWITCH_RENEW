...
export default function Globe({country,countries,onSelect,layer='model',modelCountry,modelName}:{country:Country|undefined;countries:Country[];onSelect:(iso:string)=>void;layer?:string;modelCountry?:string;modelName?:string}){
